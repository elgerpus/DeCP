...
public class SiftDescriptorContainer2 implements Serializable, Writable{
	/**
	 *
	 */
	 ...
	 */
	public SiftDescriptorContainer2() {
	 ...
	 */
	public SiftDescriptorContainer2(int id) {
        this();
        this.id = id;
	}
	/**
	 ...
	 */
	public SiftDescriptorContainer2(int id, int size) {
		this.id = id;
	 ...
	 */
	public SiftDescriptorContainer2(int id, byte[] vector) {
		this.id = id;
		this.vector = vector;
	}
